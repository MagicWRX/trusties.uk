...
function LoginButton({ redirectTo, className, supabaseClient }) {
    const [loading, setLoading] = (0, react_1.useState)(false);
    const supabase = supabaseClient || (0, client_1.createClient)();
